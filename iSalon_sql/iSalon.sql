...
-- Dumping data for table isalon.catgrupousuario: ~0 rows (approximately)
...
-- Dumping data for table isalon.cathorariogrupo: ~6 rows (approximately)
...
-- Dumping data for table isalon.cathorariosalon: ~6 rows (approximately)
...
-- Dumping data for table isalon.catmenucontent: ~23 rows (approximately)
...
-- Dumping data for table isalon.grupos: ~3 rows (approximately)
...
-- Dumping data for table isalon.horarios: ~6 rows (approximately)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertarHorario`(
    ...
    COMMENT 'grupo, horaInicio, horaFinal, Materia, Dia'
begin
...
-- Dumping data for table isalon.menucontent: ~8 rows (approximately)
...
-- Dumping data for table isalon.salones: ~0 rows (approximately)
