...
-- Dumping data for table isalon.catgrupousuario: ~5 rows (approximately)
...
-- Dumping data for table isalon.cathorariogrupo: ~5 rows (approximately)
...
-- Dumping data for table isalon.cathorariosalon: ~5 rows (approximately)
...
-- Dumping structure for procedure isalon.eliminarHorario
...
-- Dumping data for table isalon.horarios: ~5 rows (approximately)
...
INSERT INTO `menucontent` (`id`, `name`, `icon`, `link`, `target`, `priority`, `active`) VALUES
	...
	(7, 'Materias', 'library_books', 'materias/', 'content', 2, 0),
...
-- Dumping data for table isalon.messages: ~5 rows (approximately)
...
INSERT INTO `messages` (`id`, `message`, `fecha`) VALUES
	...
	(60, '[08/06/18 04:13:51]Sergio Moreno -> hola', '2018-06-08 16:13:51'),
	(61, '[08/06/18 04:14:07]Rodrigo -> ho0la', '2018-06-08 16:14:07'),
	(62, '[08/06/18 04:15:11]Axel Treviño -> hola', '2018-06-08 16:15:11');
...
-- Dumping data for table isalon.salones: ~5 rows (approximately)
