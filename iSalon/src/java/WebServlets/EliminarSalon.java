 ...
 * @author A
 */
@WebServlet(name = "EliminarGrupo", urlPatterns = {"/admin/salones/eliminarSalon"})
public class EliminarSalon extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            db.setPreparedStatement("call eliminarSalon(?)");
            ...
            Logger.getLogger(EliminarSalon.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
