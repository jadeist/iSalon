    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("name") == null) {
                ...
                request.setAttribute("redirect", "/iSalon/admin/grupos/agregarGrupo.jsp");
            ...
            if(!name.matches("[1-6].[MV][1-9]")) {
                request.setAttribute("preset", "fields");
                request.setAttribute("redirect", "/iSalon/admin/grupos/agregarGrupo.jsp");
                request.setAttribute("title", "Nombre de Grupo Inválido!");
                request.setAttribute("message", "El nombre de grupo tendrá que ser: Periodo(1-6), I, Turno (M o V), Numero de Grupo(1 - 9) [E.g. 1IM1, 3IM4, 4IV5]");
